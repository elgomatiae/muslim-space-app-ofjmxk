              ...
              <View style={styles.permissionWarningCard}>
                ...
                <View style={styles.permissionWarningContent}>
                  ...
                  <Text style={styles.permissionWarningText}>
                    Enable notifications to receive prayer reminders and updates
                  </Text>
                </View>
                <TouchableOpacity
              ...
              <View style={styles.settingsCard}>
                <View style={styles.settingRow}>
                  ...
                  <Switch
                    ...
                    disabled={savingSettings || permissionStatus !== 'granted'}
                  />
                </View>
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.section}>
                ...
                <View style={styles.permissionHeader}>
                  ...
                  <View style={styles.permissionTextContainer}>
                    ...
                    <Text style={styles.permissionDescription}>
                      Enable notifications to receive prayer reminders, dhikr alerts, and achievement updates.
                    </Text>
                  </View>
                </View>
                <TouchableOpacity
            ...
            {permissionStatus === 'granted' && (
              <View style={styles.permissionSuccessCard}>
                <IconSymbol
                  ios_icon_name="checkmark.circle.fill"
                  android_material_icon_name="check-circle"
                  size={24}
...
const styles = StyleSheet.create({
  ...
  permissionCard: {
    ...
    borderWidth: 2,
    borderColor: colors.warning,
    boxShadow: '0px 2px 6px rgba(255, 152, 0, 0.2)',
    elevation: 2,
  },
  permissionHeader: {
    flexDirection: 'row',
