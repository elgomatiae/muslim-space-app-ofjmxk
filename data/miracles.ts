    ...
    miracles: [
      {
        ...
        description: 'The Prophet ﷺ prophesied the peaceful conquest of Makkah.',
        details: 'The Prophet Muhammad ﷺ saw a vision that he and his companions would enter Makkah safely. This prophecy was fulfilled when Makkah was conquered peacefully in 630 CE, as mentioned in Quran 48:27.',
        reference: 'Quran 48:27',
        image: 'https://images.unsplash.com/photo-1591604466107-ec97de577aff?w=800&q=80',
      },
      {
        id: 'p2',
        title: 'Protection of the Quran',
        description: 'The Prophet ﷺ prophesied the Quran would be preserved.',
        details: 'The Prophet Muhammad ﷺ said the Quran would be preserved and protected from corruption. Over 1400 years later, the Quran remains unchanged with millions having memorized it completely.',
        reference: 'Sahih Hadith Collections',
        image: 'https://images.unsplash.com/photo-1609599006353-e629aaabfeae?w=800&q=80',
      },
      {
        id: 'p3',
        title: 'Spread of Islam',
        description: 'The Prophet ﷺ prophesied Islam would spread across the world.',
        details: 'The Prophet Muhammad ﷺ said: "This matter (Islam) will reach wherever the night and day reach." Today, Islam is the second-largest religion with over 1.8 billion followers worldwide.',
      ...
      },
      {
        ...
        description: 'The Prophet ﷺ prophesied people would compete in building tall structures.',
        details: 'The Prophet Muhammad ﷺ mentioned as a sign of the Last Day: "You will see barefoot, naked, destitute shepherds competing in constructing tall buildings." This is evident in modern skyscraper competitions.',
      ...
      },
      {
        ...
        description: 'The Prophet ﷺ prophesied Muslims would conquer the Persian and Roman empires.',
        details: 'The Prophet Muhammad ﷺ prophesied that Muslims would conquer the treasures of the Persian and Roman empires. Both prophecies were fulfilled within decades of his death.',
